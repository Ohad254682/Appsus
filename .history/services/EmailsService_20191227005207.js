...
function sorting(emails, sortingStatus) {
    var sorted = emails.sort(function (email1, email2) {
        const varA = (typeof email1[sortingStatus] === 'string') ? email1[sortingStatus].toUpperCase() : email1[sortingStatus];
        const varB = (typeof email2[sortingStatus] === 'string') ? email2[sortingStatus].toUpperCase() : email2[sortingStatus];
        return varA[sortingStatus] - varB[sortingStatus] > 0 ? 1 : varA[sortingStatus] - varB[sortingStatus] < 0 ? -1 : 0;
    })
