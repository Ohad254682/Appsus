...
export default class EmailsPage extends React.Component {
    ...
    filterReadMails = () => {
        this.setState({ filterMode: 'Read' }, this.LoadEmails(this.setState.filterBy, this.prevState.filterMode))
    }

    filterUnreadMails = () => {
        this.setState({ filterMode: 'Unread' }, this.LoadEmails(this.setState.filterBy, this.prevState.filterMode))
    }
