        ...
        return <React.Fragment>
            <div className="form-container">
                ...
                <div className="inputs">
                    ...
                    <textarea type="text" placeholder="" name="body" rows="15" cols="50" onChange={this.onInputChange} value={Parser(this.state.body)}></textarea>
