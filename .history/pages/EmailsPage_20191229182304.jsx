        ...
        return (
            <div className="emails-page-container">
                ...
                <section className="email-list-container">
                    {this.state.isComposing && <EmailAdd email={this.state.selectedEmail} stopComposing={this.stopComposing}></EmailAdd>}
                    {(this.state.selectedEmail) ? <EmailDetails onReply={this.props.onReply} removeSelectedEmail={this.removeSelectedEmail} email={this.state.selectedEmail}></EmailDetails>
                        :
