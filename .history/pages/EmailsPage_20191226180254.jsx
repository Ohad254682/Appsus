...
export default class EmailsPage extends React.Component {
    ...
    filterReadMails = () => {
        this.setState({ filterMode: 'Read' }, this.loadEmails(this.setState.filterBy, 'Read'))
    }

    filterUnreadMails = () => {
        this.setState({ filterMode: 'Unread' }, this.loadEmails(this.setState.filterBy, 'Unread'))
    }
