...
export default class EmailsPage extends React.Component {
    ...
    filterReadMails = () => {
        EmailsService.getEmails()
            .then(emails => emails.filter(email=>email.isRead)).then(this.setState({emails}))
    }
    ...
    render() {
        ...
        return (
            <div className="emails-page-container">
                <SideNav filterReadMails={this.filterReadMails} startComposing={this.startComposing}></SideNav>
