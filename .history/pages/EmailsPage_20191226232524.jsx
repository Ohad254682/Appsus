    ...
    render() {
        ...
        return (
            <div className="emails-page-container">
                <SideNav onSortBySubject={this.onSortBySubject} onSortBySentAt={this.onSortBySentAt} filterStarredMails={this.filterStarredMails} filterAll={this.filterAll} filterReadMails={this.filterReadMails} filterUnreadMails={this.filterUnreadMails} startComposing={this.startComposing} emails={this.state.emails}></SideNav>
