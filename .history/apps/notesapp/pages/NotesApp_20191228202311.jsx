    ...
    render() {
        return <React.Fragment>
            <div className="container notes-page-container">
                ...
                <NotesList onLoadNotes={this.onLoadNotes} colorMode={this.state.colorMode} onToggleColorPicker={this.onToggleColorPicker} setFilterBy={this.setFilterBy} onDeleteNote={this.onDeleteNote} notes={this.state.notes} onAddNote={this.props.onAddNote} onChangeColor={this.onChangeColor} onSelectNote={this.onSelectNote} onCopyNote={this.onCopyNote} />
            </div>
        </React.Fragment>
    }
}