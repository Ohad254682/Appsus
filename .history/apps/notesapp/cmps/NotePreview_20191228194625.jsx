        ...
        return (
            <article className="cards-container" id="container" style={{ backgroundColor: this.props.note.info.backgroundColor }} onClick={this.onSelectNote}>
                ...
                <div className="tools-bar">
                    ...
                    {this.state.colorMode && <ColorPicker onLoadNotes={this.props.onLoadNotes} note={note} onOpenColorPicker={this.onOpenColorPicker} onCloseColorPicker={this.onCloseColorPicker}></ColorPicker>}
