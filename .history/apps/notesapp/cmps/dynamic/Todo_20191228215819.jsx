...
export default class Todo extends React.Component {
    ...
    render() {
        return <div>
            <input type="text" name="label" className={todo.isDone ? 'todo-isdone ' : ''} type="text" onChange={this.onChangeInput} value={this.state.label} disabled={this.props.isEditMode ? false : true}></input>
            <ul>
