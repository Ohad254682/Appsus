...
export default class Todo extends React.Component {
    ...
    render() {
        return <div>
            <input type="text" name="textarea" className={todo.isDone ? 'todo-isdone ' : ''} type="text" onChange={this.onChangeInput} value={this.state.label} disabled={this.props.isEditMode ? false : true}></input>
            <ul>
                {this.props.note.info.todos.map(todo =>
                    <li key={todo.id} className="todolist">
                        <input type="text" name="textarea" className={todo.isDone ? 'todo-isdone ' : ''} type="text" onChange={this.onChangeInput} value={this.state.textarea} disabled={this.props.isEditMode ? false : true}></input>
